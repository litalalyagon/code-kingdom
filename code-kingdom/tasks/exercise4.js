...
class Exercise4 extends Exercise {
  ...
  extractInputs(selects, inputs) {
    ...
    if (this.level === 'easy') {
      full_string = hebrewDict.ex4.bridge_var + ' = ' + full_string;
     }
  ...
  isValid(vars) {
    ...
    if (!variable || variable !== hebrewDict.ex4.bridge_var) {
      return {valid: false, message: hebrewDict.ex4.empty_new_bridge_error};
    }
