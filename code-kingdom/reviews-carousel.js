const reviews = [
            ...
            {text: "מדי זמן מה שאני מנסה לעניין את בנותיי בטכנולוגיה במגוון דרכים - ורק הספר שלכם הצליח לעשות את העבודה. הן ממש מרותקות לסיפור, מתעניינות, מבינות את ההסברים ומבקשות עוד ועוד מדי יום.", author: "יואב, אבא לשתי בנות בגילאי גן ויסודי"},
            {text: "הספר ממש נפלא! יצר רגעי חיבור מהממים עם אבא שבא מהתחום!", author: "בת-חן"},
